...
object FixedAlarmCollector extends LazyLogging {
  def main(args: Array[String]): Unit = {
    ...
    //				)
    val project_name = "maven-dependency-plugin"
    collectFixedAlarmsByProject("/data/result/" + project_name + "-fixed-alarms.csv",
      "/data/result/repoDir/" + project_name + "/.git",
      project_name,
      "/data/result/" + project_name + "-vtype-stat.csv",
      "/data/result/" + project_name + "-summary-project-vtype.csv")
